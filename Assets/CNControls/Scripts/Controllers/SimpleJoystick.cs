...
namespace CnControls
{
...
#endif
    {
        ...
        private void Awake()
        {
			...
			_joystickTransform = GetComponent<RectTransform>();
            _stickTransform = Stick.GetComponent<RectTransform>();
            _baseTransform = Base.GetComponent<RectTransform>();

			_joystickTransform.localScale = new Vector2(1.5f * ratio, 1.5f * ratio);
			_joystickTransform.anchoredPosition = new Vector3 (-300 * ratio, 0f, 0f);
